...
<main class="flex-1 p-4">
    <div class="grid grid-cols-2">
        <div class="p-12 flex flex-col items-start space-y-8">
            ...
            <p class="text-md">Use this form to enter details for a new user. Accurate data helps maintain organized records and supports the purging and sorting process.</p>
        ...
        <div class="p-12 overflow-y-auto max-h-[calc(100vh-4rem)] flex items-center justify-center">
            <form id="add-new-user-form" action="/users/add" method="POST">
                <div class="flex flex-col space-y-8">
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="grid grid-cols-2 gap-x-8">
                            <div class="flex flex-col space-y-1">
                                ...
                                <input type="text" name="username" class="text-sm p-2 border border-[#393E46] text-[#393E46] rounded focus:outline-none" value="<?= $_POST['username'] ?? '' ?>">
                            ...
                            <div class="flex flex-col space-y-1">
                                ...
                                <input type="text" name="id_number" class="text-sm p-2 border border-[#393E46] text-[#393E46] rounded focus:outline-none" value="<?= $_POST['id_number'] ?? '' ?>">
                        ...
                        <div class="grid grid-cols-1">
                            <div class="flex flex-col space-y-1">
                                ...
                                <select name="role" class="text-sm p-2 border border-[#393E46] text-[#393E46] rounded focus:outline-none">
                                    <option class="text-sm" value="user" <?= isset($_POST['role']) === 'user' ? 'selected' : '' ?>>User</option>
                                    <option class="text-sm" value="admin" <?= isset($_POST['role']) === 'admin' ? 'selected' : '' ?>>Admin</option>
                                </select>
                        ...
                        <div class="grid grid-cols-2 gap-x-8">
                            <div class="flex flex-col space-y-1">
                                ...
                                <div class="relative password-section">
                                    <input type="password" name="password" class="password-input text-sm p-2 pr-10 border  border-[#393E46] text-[#393E46] rounded focus:outline-none" value="<?= $_POST['password'] ?? '' ?>">
                            ...
                            <div class="flex flex-col space-y-1">
                                ...
                                <div class="relative password-section">
                                    <input type="password" name="confirm_password" class="password-input text-sm p-2 pr-10 border border-[#393E46] text-[#393E46] rounded focus:outline-none" value="<?= $_POST['confirm_password'] ?? '' ?>">
                                    <button type="button" class="absolute transform translate-y-1/2 right-2 show-password">
                                        <img src="/images/show-black.svg" class="w-5 h-5 show-password-img" alt="">
                                    </button>
                                </div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <button type="submit" class="cursor-pointer p-2 w-full bg-gray-600 hover:bg-[#45D4A4] text-white flex items-center justify-center rounded transition">Add User</button>
                    </div>
